...
public class HobbiesAndInterestsRequest {
	...
	public String toString() {
		return "HobbiesAndInterestsRequest [hobbies=" + hobbies + ", otherHobbies=" + otherHobbies + ", favouriteMusic="
				+ favouriteMusic + ", otherMusic=" + otherMusic + ", sports=" + sports + ", otherSports=" + otherSports
				+ ", favouriteFood=" + favouriteFood + ", otherFood=" + otherFood + "]";
	}
